...
- (void)joinLive:(AUIRoomLiveInfoModel *)roomModel {
  [[AUILiveManager liveManager] joinLive:roomModel currentVC:self completed:^(BOOL success, AUIRoomLiveInfoModel * _Nonnull model, NSArray<AUIRoomLiveLinkMicJoinInfoModel *> * _Nonnull joinList) {
    if (success) {
