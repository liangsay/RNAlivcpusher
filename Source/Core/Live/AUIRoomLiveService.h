...
/**
 点赞自定义消息
 */
@interface AUIRoomCustomLikeModel : NSObject<AUIMessageDataProtocol>
@property (nonatomic, copy) NSString *messageId;
@property (nonatomic, copy, readonly) NSString *groupId;
@property (nonatomic, copy, readonly) NSString *msgType;
...
@property (nonatomic, copy) void (^onReceivedCustomLike)(AUIRoomUser *sender, AUIRoomCustomLikeModel *like);
