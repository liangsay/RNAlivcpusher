...
- (void)setupBeautyController:(void (^)(QueenEngine * _Nonnull))completed {
    @synchronized (self) {
        if (self.beautyEngine) {
            completed(self.beautyEngine);
            return;
        }
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [self.beautyEngine setQueenBeautyType:kQueenBeautyTypeSkinBuffing enable:YES mode:kQueenBeautyFilterModeDefault];
            // 打开美白功能开关
