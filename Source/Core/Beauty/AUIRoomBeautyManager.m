...
#ifndef DISABLE_QUEEN
    AUIRoomBeautyQueenController *beautyQueenController = [[AUIRoomBeautyQueenController alloc] initWithPresentView:presentView contextMode:contextMode];
    return beautyQueenController;
#else
    return nil;
#endif
}
