...
- (void)queryListGroupUserWithGroupID:(NSString *)groupId sortType:(int32_t)sortype pageNum:(int32_t)pageNum pageSize:(int32_t)pageSize
    ...
    AVCIInteractionEngine *interactionEngine = [self.messageService getNativeEngine];
    [interactionEngine.interactionService listGroupUserWithGroupID:groupId sortType:sortype pageNum:pageNum pageSize:pageSize onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)queryGroupUserByIdListWithGroupID:(NSString *)groupId userIdList:(NSArray<NSString*>*)userIdList
                                ...
                                onFailure:(void (^)(AVCIInteractionError* error))onFailure{
    AVCIInteractionEngine *interactionEngine = [self.messageService getNativeEngine];
    [interactionEngine.interactionService getGroupUserByIdListWithGroupID:groupId userIdList:userIdList onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)onAliveMessageReceived:(AUIMessageModel *)model {
